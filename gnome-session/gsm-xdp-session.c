...
static gboolean
handle_close_ex (XdpImplSession        *skeleton,
                 GDBusMethodInvocation *invocation,
                 GVariant              *options,
                 GsmXdpSession         *session)
{
        ...
        xdp_impl_session_complete_close_ex (skeleton, invocation);
                        ...
                        GError          **error)
{
        ...
        g_signal_connect (skeleton, "handle-close",
                          ...
                          session);
        g_signal_connect (skeleton, "handle-close-ex",
                          G_CALLBACK (handle_close_ex),
                          session);
